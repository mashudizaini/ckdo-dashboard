...
const NAV_ITEMS = [
  ...
  { label: "HRGA", path: "/dashboard/hr", icon: Users, roles: ["hr_staff"], children: [
    ...
    { label: "e-Magazine Viewer — Upload", path: "/e-magazine-viewer/admin?tab=editions&type=magazine" },
    { label: "Photo Album — Upload", path: "/e-magazine-viewer/admin?tab=editions&type=album" },
  ] },
