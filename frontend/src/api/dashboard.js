...
export const hrApi = {
  ...
  syncOrgStructureJoinDates: ()       => api.post("/dashboard/hr/org-structure/sync-join-dates"),
...
export const financialStatementApi = {
  ...
  getBalanceSheet:       (periods, source = "oracle", accountGroup = "", signal) => api.get("/dashboard/accounting/financial-statement/balance-sheet", { params: { periods: periods.join(","), source, account_group: accountGroup || undefined }, signal }),
  getBalanceSheetDetail: (periods, accountGroup = "", signal) => api.get("/dashboard/accounting/financial-statement/balance-sheet-detail", { params: { periods: periods.join(","), account_group: accountGroup || undefined }, signal }),
