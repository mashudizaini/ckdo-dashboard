...
const APPS = [
  ...
  { id: "eticket",    name: "E-Ticket System",   desc: "Helpdesk & ticketing",         url: "http://helpdesk.ckd-otto.com/dashboard", status: "sso",    emoji: "🎫", role: "app:eticket"     },
  { id: "eticket-dev", name: "E-Ticket System New", desc: "Helpdesk & ticketing New", url: "http://helpdesk.ckd-otto.com/dashboard", status: "direct", emoji: "🧪", role: "app:eticket-dev" },
