...
import {
  Banknote, ExternalLink, RefreshCw, X,
  Download, Loader2,
...
/* ─── Tabs ────────────────────────────────────────── */
// Budget Usage Report moved to Dashboard > General (2026-08-19 user
// request) — see src/pages/dashboard/general/BudgetUsageReport.jsx.
// Still calls pacApi.getBudgetUsage/getLedgers (backend stays
// pac_staff/admin-gated per explicit user decision — only the nav
// location moved, not data access).
const TABS = [
