  ...
  return (
    <div className="p-6 space-y-5">
      ...
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1">Record meeting — Auto transcript — Minutes of Meeting (AI-powered)</p>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="rounded-xl border border-gray-800 bg-gray-900 p-5 text-center">
              ...
              <p className="text-xs text-gray-600 mb-4">Record meeting audio in real-time</p>
          ...
          <div className="rounded-xl border border-purple-500/30 bg-purple-500/5 p-5">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-sm font-semibold text-gray-200">Generate MOM with AI</h3>
            </div>
            <p className="text-xs text-gray-500 mb-4">
              AI will automatically create a transcript, summarize key points, and generate Minutes of Meeting.
            </p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3 mt-0.5">
                      ...
                      <span className="flex items-center gap-1 text-xs text-gray-500">
                        <Users size={11} />{item.participants} participants
                      </span>
                    </div>
                  </div>
                </div>
