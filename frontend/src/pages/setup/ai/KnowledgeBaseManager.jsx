...
/**
 * Knowledge Base document manager — moved here from a modal opened inside
 * the AI Chatbot page (Setup > AI, 2026-09-03), so it's an admin/management
 * concern under Setup instead of a button readers of the chatbot itself
 * would stumble across. Same component logic as before, just a plain
 * embedded panel now instead of a floating dismissible modal (no more
 * fixed inset-0 overlay / onClose — it lives on its own page).
 */
