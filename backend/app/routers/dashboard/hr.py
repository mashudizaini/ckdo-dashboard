...
from app.routers.dashboard import hr_employees, hr_attendance, hr_budget, hr_initiatives, hr_leave, hr_calendar, hr_todo, hr_cv_screening, hr_emagazine, hr_org_structure
