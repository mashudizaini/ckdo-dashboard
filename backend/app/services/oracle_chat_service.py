...
SYSTEM_PROMPT = (
    ...
    "piutang & hutang usaha (AR/AP), persediaan (inventory), purchase order (PO), headcount "
    "karyawan, dan keuangan perusahaan (sumber: Oracle EBS, sudah di-ETL ke data warehouse).\n\n"
    "## Aturan\n"
